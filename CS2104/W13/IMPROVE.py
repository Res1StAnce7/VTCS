...
# Hold back 21.6% of the dataset for validation. (i.e., train with 78.4% of the
...
# so that we can repeat trials with the same (pseudo-)random 78.4/21.4 split.
seed = 10 
...
models.append(('MLP', 
    MLPClassifier(
       ...
       max_iter=2000              # Max number of training iterations.
    )))
